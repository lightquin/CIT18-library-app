...
<div class="space-y-6">
    ...
    <div class="rounded-2xl p-6 text-white relative overflow-hidden"
        ...
        <div class="relative z-10">
            <p class="text-blue-600 text-sm font-medium mb-1">Good {{ now()->hour < 12 ? 'morning' : (now()->hour < 17 ? 'afternoon' : 'evening') }},</p>
        ...
        <div class="absolute -right-8 -top-8 w-40 h-40 rounded-full bg-blue-500/10"></div>
        <div class="absolute -right-4 -bottom-12 w-56 h-56 rounded-full bg-blue-500/5"></div>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        $statCards = [
            ...
            ['label' => 'Borrowed',          'value' => $stats['active_borrowings'], 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', 'color' => 'text-teal-600 bg-teal-50'],
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div class="card">
            <div class="flex items-center justify-between p-5 border-b border-ink-100">
                ...
                <a href="{{ route('books.index') }}" class="text-blue-600 text-sm font-medium hover:text-blue-700">View all →</a>
            </div>
            <div class="divide-y divide-ink-50">
                @forelse($recentBooks as $book)
                <div class="p-4 flex items-center gap-4 hover:bg-ink-50/50 transition-colors">
                    <div class="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center flex-shrink-0 text-blue-700 font-display font-bold text-sm">
        ...
        <div class="card">
            <div class="flex items-center justify-between p-5 border-b border-ink-100">
                ...
                <a href="{{ route('borrowings.index') }}" class="text-blue-600 text-sm font-medium hover:text-blue-700">View all →</a>
            </div>
            <div class="divide-y divide-ink-50">
