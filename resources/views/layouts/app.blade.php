...
<head>
    ...
    <style>
        ...
        /* Sidebar - Switched to a Deep Navy Gradient */
        .sidebar { background: linear-gradient(160deg, #0f172a 0%, #1e293b 60%, #334155 100%); }
        ...
        /* Buttons - Updated to Blue Gradients */
        .btn-primary {
        ...
        /* Form inputs - Focus border is now Blue */
        .form-input {
    ...
    <aside class="sidebar w-64 flex-shrink-0 flex flex-col overflow-y-auto z-30 fixed md:static h-full" id="sidebar">
        ...
        <nav class="flex-1 p-4 space-y-1 mt-2">
            ...
            <a href="{{ route('members.index') }}"
                class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-ink-200 text-sm {{ request()->routeIs('members.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('borrowings.index') }}"
                class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-ink-200 text-sm {{ request()->routeIs('borrowings.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('categories.index') }}"
                class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-ink-200 text-sm {{ request()->routeIs('categories.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-4 border-t border-white/10">
            <div class="flex items-center gap-3 mb-3">
                <div class="w-9 h-9 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 font-semibold text-sm">
